...
/**
 * Search page client logic — kept in its own file so the wrapping
 * page.tsx can stay a Server Component (required so we can use the
 * `export const dynamic = 'force-dynamic'` route segment config to
 * skip static prerender of a page that reads URL search params).
 */
